...
const BhaktapurProperties = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        const res = await api.get("properties/city/bhaktapur");
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] w-full bg-red-50 rounded-lg p-6">
        ...
        <p className="text-gray-600 text-center">
          We encountered an error while fetching properties in Bhaktapur. Please try again later.
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center gap-2 mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Properties in Bhaktapur</h1>
      </div>
      ...
      {properties.length > 0 ? (
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center text-gray-600 mb-3">
                  ...
                  <span className="text-sm">{property.location || "Bhaktapur"}</span>
                </div>
        ...
        <div className="bg-gray-50 rounded-lg p-8 text-center">
          ...
          <p className="text-xl font-medium text-gray-600 mb-2">No properties found for Bhaktapur</p>
...
export default BhaktapurProperties;
